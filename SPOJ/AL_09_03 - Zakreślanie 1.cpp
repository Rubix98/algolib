// Task: AL_09_03 - Zakreślanie 1 (SPOJ)
// URL: https://pl.spoj.com/problems/AL_09_03/
...
struct Line {
    ...
    Line(LL a, LL b, LL c): a(a), b(b), c(c), pts(0) {}
...
int main() {
    ...
    TESTS(t) {
        ...
        REP(i, n) {
            int x, y;
            cin >> x >> y;
            if (i == 0 || !(points.back() == Point(x, y)))
            points.PB(Point(x, y));
        }
        if ((int)points.size() < 2) cout << "TAK" << endl;
        else {
